...
namespace NorthwindTest.Models
{
    ...
    public class Suppliers : Entity 
    {
        #region Columns
        [PrimaryKey]
        public readonly NumberColumn SupplierID = new NumberColumn("SupplierID", "N10") { ReadOnlyForExistingRows = true, NullDisplayText = "" };
        ...
        #endregion
        public Suppliers() : base("Suppliers", NorthwindTest.Shared.DataSources.NorthwindSQL)
        {
            InitializeIndexes();
        }
