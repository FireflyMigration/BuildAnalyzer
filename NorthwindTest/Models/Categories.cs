...
namespace NorthwindTest.Models
{
    ...
    public class Categories : Entity 
    {
        #region Columns
        [PrimaryKey]
        public readonly NumberColumn CategoryID = new NumberColumn("CategoryID", "N10") { ReadOnlyForExistingRows = true, NullDisplayText = "" };
        ...
        #endregion
        public Categories() : base("Categories", NorthwindTest.Shared.DataSources.NorthwindSQL)
        {
            InitializeIndexes();
        }
