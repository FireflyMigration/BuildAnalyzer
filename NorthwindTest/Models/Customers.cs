...
namespace NorthwindTest.Models
{
    ...
    public class Customers : Entity 
    {
        #region Columns
        [PrimaryKey]
        public readonly Types.CustomerID CustomerID = new Types.CustomerID { Caption = "CustomerID", Name = "CustomerID" };
        ...
        #endregion
        public Customers() : base("Customers", NorthwindTest.Shared.DataSources.NorthwindSQL)
        {
