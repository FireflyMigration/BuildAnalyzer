...
namespace NorthwindTest
{
    ...
    internal class Print_Orders : BusinessProcessBase 
    {
        #region Models
        ...
        #endregion
        #region Layouts
        Printing.Print_OrdersC1 _layout { get { return Cached<Printing.Print_OrdersC1>(); } }
        #endregion
        public Print_Orders()
        {
            Title = "Print - Orders";
        ...
        {
            Groups[Orders.CustomerID].Enter += () => 
            #region
            {
