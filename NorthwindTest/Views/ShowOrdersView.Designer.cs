...
namespace NorthwindTest.Views
{
    partial class ShowOrdersView
    {
        ...
        Shared.Theme.Controls.GroupBox grp1;
        ...
        void InitializeComponent()
        {
            ...
            this.lblOrder = new NorthwindTest.Shared.Theme.Controls.CompatibleLabel();
            this.txtOrders_OrderID = new NorthwindTest.Shared.Theme.Controls.CompatibleTextBox();
            this.lblCustomer = new NorthwindTest.Shared.Theme.Controls.CompatibleLabel();
            this.grp = new NorthwindTest.Shared.Theme.Controls.GroupBox();
            this.lblOrderDate = new NorthwindTest.Shared.Theme.Controls.CompatibleLabel();
            this.txtOrders_OrderDate = new NorthwindTest.Shared.Theme.Controls.CompatibleTextBox();
            this.lblShipAddress = new NorthwindTest.Shared.Theme.Controls.CompatibleLabel();
            this.txtOrders_ShipAddress = new NorthwindTest.Shared.Theme.Controls.CompatibleTextBox();
            this.lblRequiredDate = new NorthwindTest.Shared.Theme.Controls.CompatibleLabel();
            this.txtOrders_RequiredDate = new NorthwindTest.Shared.Theme.Controls.CompatibleTextBox();
            this.lblShipCity = new NorthwindTest.Shared.Theme.Controls.CompatibleLabel();
            this.txtOrders_ShipCity = new NorthwindTest.Shared.Theme.Controls.CompatibleTextBox();
            this.lblShippedDate = new NorthwindTest.Shared.Theme.Controls.CompatibleLabel();
            this.txtOrders_ShippedDate = new NorthwindTest.Shared.Theme.Controls.CompatibleTextBox();
            this.lblShipCountry = new NorthwindTest.Shared.Theme.Controls.CompatibleLabel();
            this.txtOrders_ShipCountry = new NorthwindTest.Shared.Theme.Controls.CompatibleTextBox();
            this.grp1 = new NorthwindTest.Shared.Theme.Controls.GroupBox();
            this.txtV_Total = new NorthwindTest.Shared.Theme.Controls.CompatibleTextBox();
            this.lblTotal = new NorthwindTest.Shared.Theme.Controls.CompatibleLabel();
            this.cboOrders_CustomerID = new NorthwindTest.Shared.Theme.Controls.ComboBox();
            this.btn = new NorthwindTest.Shared.Theme.Controls.Button();
            this.btnPrint = new NorthwindTest.Shared.Theme.Controls.Button();
            this.btn1 = new NorthwindTest.Views.Controls.Close1();
            this.SuspendLayout();
            
            // lblOrder
            
            this.lblOrder.ColorScheme = this.clrBlue;
            ...
            this.lblCustomer.ColorScheme = this.clrBlue;
            ...
            this.grp.ColorScheme = this.clrBlue;
            ...
            this.lblOrderDate.ColorScheme = this.clrBlue;
            ...
            this.lblShipAddress.ColorScheme = this.clrBlue;
            ...
            this.lblRequiredDate.ColorScheme = this.clrBlue;
            ...
            this.lblShipCity.ColorScheme = this.clrBlue;
            ...
            this.lblShippedDate.ColorScheme = this.clrBlue;
            ...
            this.lblShipCountry.ColorScheme = this.clrBlue;
            ...
            this.grp1.ColorScheme = this.clrBlue;
            this.grp1.ForceTransparentBackgroundOnStandardStyle = true;
            this.grp1.Location = new System.Drawing.Point(303, 320);
            this.grp1.Name = "grp1";
            this.grp1.Size = new System.Drawing.Size(173, 39);
            this.grp1.Style = Firefly.Box.UI.ControlStyle.Standard;
            this.grp1.Text = "";
            
            // txtV_Total
            
            this.txtV_Total.Alignment = System.Drawing.ContentAlignment.MiddleRight;
            this.txtV_Total.BoundTo = new Firefly.Box.UI.ControlBinding(this.grp1);
            ...
            this.lblTotal.BoundTo = new Firefly.Box.UI.ControlBinding(this.grp1);
            this.lblTotal.ColorScheme = this.clrBlue;
            ...
            this.cboOrders_CustomerID.BindListSource += new Firefly.Box.UI.Advanced.BindingEventHandler<System.EventArgs>(cboOrders_CustomerID_BindListSource);
            ...
            this.btn1.Location = new System.Drawing.Point(410, 380);
            this.btn1.Name = "btn1";
            this.btn1.RaiseClickBeforeFocusChange = true;
            this.btn1.Size = new System.Drawing.Size(69, 23);
