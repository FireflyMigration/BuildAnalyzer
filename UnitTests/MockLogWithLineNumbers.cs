namespace UnitTests
{
    class MockLogWithLineNumbers : MockFilesProvider
    {
        ...
        {
            return "     1>TestSubFormCallFor357.cs(52,37): error CS1002: ; expected [C:\\Users\\Sefi\\Source\\Repos\\BuildAnalyzer\\NorthwindTest\\NorthwindTest.csproj]\r\n" +
                   "\r\n" +
                   "Build FAILED.\r\n" +
                   "    2 Warning(s)\r\n" +
                   "    1 Error(s)\r\n" +
